-- Migration: 0024_add_user_tokens
-- Renumbered from 0010 to avoid conflicts with 0010_add_coach_extraction
-- Note: remove legacy 0010_add_user_tokens.sql from migrations root
