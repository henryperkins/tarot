...
- `integrations/openai/chatgpt-gpt-actions-setup.md` - Custom GPT / GPT Actions setup
- `integrations/openai/tableau-backend-chatgpt-app-integration.md` - ChatGPT App + MCP adapter setup
